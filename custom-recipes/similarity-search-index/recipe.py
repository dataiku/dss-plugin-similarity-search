...
save_array(array=vector_ids, path=algorithm.VECTOR_IDS_FILE_NAME, folder=params["index_folder"])
save_array(array=vectors, path=algorithm.VECTORS_FILE_NAME, folder=params["index_folder"])
